...
var InstagramCommentPage = (function () {
    ...
    InstagramCommentPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-instagram-comment',template:/*ion-inline-start:"D:\Visual Studio\Personal\Project-Watermellon\src\pages\ready-app\instagram\instagram-comment\instagram-comment.html"*/'<!--\n\n  Generated template for the InstagramCommentPage page.\n\n\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n\n  Ionic pages and navigation.\n\n-->\n\n<ion-header>\n\n\n\n  <ion-navbar>\n\n    <ion-title>instagram-comment</ion-title>\n\n  </ion-navbar>\n\n\n\n</ion-header>\n\n\n\n\n\n<ion-content>\n\n  <ion-spinner class="indicator" [ngClass]="spnState"></ion-spinner>\n\n  <ion-list>\n\n  <ion-item *ngFor="let item of list">\n\n    <ion-avatar item-start>\n\n      <img src="{{item.from.profile_picture}}">\n\n    </ion-avatar>\n\n    <h2>{{item.from.username}}</h2>\n\n    <p>{{item.text}}</p>\n\n  </ion-item>\n\n </ion-list>\n\n</ion-content>\n\n'/*ion-inline-end:"D:\Visual Studio\Personal\Project-Watermellon\src\pages\ready-app\instagram\instagram-comment\instagram-comment.html"*/,
        }),
